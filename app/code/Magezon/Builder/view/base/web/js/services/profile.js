    ...
    var profileService = function (
        ...
        this.import = function () {
            ...
            $rootScope.$apply(function () {
                $rootScope.profile = angular.extend(
                    $rootScope.profile,
                    profile
                );
                if (content) {
        ...
        this.prepareProfile = function (content, force) {
            ...
            if (isJSON) {
                ...
                profile.elements = elementManager.prepareElements(
                    angular.copy(_profile.elements),
                    force
                );
            }
            if (!profile["pid"])
                profile["pid"] = magezonBuilderService.getUniqueId();
            return profile;
        };
        ...
        this.toString = function () {
            ...
            if (!result["pid"])
                result["pid"] = magezonBuilderService.getUniqueId();
        ...
        this.prepareElements = function (elements) {
            ...
            angular.forEach(_elements, function (element) {
                ...
                if (builderElement) {
                    if (element.elements) {
                        element.elements = self.prepareElements(
                            element.elements
                        );
                    }
